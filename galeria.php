							...
							<ul class="nav navbar-nav">
								<li class="dropdown">
									...
									<ul class="dropdown-menu agile_short_dropdown">
										<li class="active"><a href="presidente.php">Presidente Municipal</a></li>
								...
								<li class="active"><a>Tramites y Servicios</a></li>
								<li><a href="galeria.php">Galería</a></li>
								<li  class="active" class="dropdown">
									<a  class="dropdown-toggle" data-toggle="dropdown">Dependencias<b class="caret"></b></a>
...
<div class="agileinfo-gal">
		<div class="container">
		<h2 class="w3l_head w3l_head1">Galería</h2>
			<div class="agileits_portfolio_grids">
				<div class="col-md-3 agileits_portfolio_grid">
					<a href=""></a><div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/Bacheo-La-Camecha/1 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/Bacheo-La-Camecha/1 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Bacheo La Camecha</h4>
								<p> </p> 
							</div>
						</a>
					</div>
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/Barda_Escuela_Charapuato/2 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/Barda_Escuela_Charapuato/2 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Barda perimetral</h4>
								<p>Escuela Charapuato</p> 
							</div>
						</a>
					</div>
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/Blv_NinosHeroes/3 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/Blv_NinosHeroes/3 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Bulevar</h4>
								<p>Niños Héroes</p> 
							</div>
				...
				<div class="col-md-3 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/BuenosAires-ElTerrero/4 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/BuenosAires-ElTerrero/4 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Buenos Aires - El Terrero</h4>
								<p> </p> 
							</div>
						</a>
					</div>
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/Calle_Colon/5 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/Calle_Colon/5 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Calle Colón</h4>
								<p> </p> 
							</div>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/Calle_FranciscoMendoza/6 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/Calle_FranciscoMendoza/6 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4> Calle Francisco Mendoza</h4>
								<p> </p> 
							</div>
						</a>
					</div>
				...
				<div class="col-md-3 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="galeria/2016-1/obras-publicas/Calle_JesusAyala/7 (1) copia.jpg">
							<img src="galeria/2016-1/obras-publicas/Calle_JesusAyala/7 (1) copia.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Calle Jesús Ayala</h4>
								<p> </p> 
							</div>
						</a>
					</div>
